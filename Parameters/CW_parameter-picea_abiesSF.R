...
zd.fak <- 0.74   # = d/H, relation between displacement height and the vegetation height --> adapted by SF [Queck 2004: Fraktionierung und zeitliche Differenzierung von Depositionsraten in Waldbestände]
