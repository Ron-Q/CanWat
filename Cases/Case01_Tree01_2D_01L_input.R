#+
# NAME*:        Tree01_2D_01L_input.R
# PURPOSE*:     CanWat input parameters for the Anchorstation Tharandter Wald 
# RELEVANCY*:   CanWat
# CALLING SEQ.: source(file.path(path_sub,"Case01_3D_input.r"))
# INPUTS*: 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #* name and range ####
  fnam.SD <- "Tree01_2D_01L.csv" # -, name of the static driver
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  fnam.MetData <- "Case01_DynD.csv" # -, name of the dynamic driver
