...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #* name and range ####
  fnam.SD <- "Tree01_1D_02L.csv" # -, name of the static driver
  SD.dims = c( 2, 1,  1)      # -, [z,y,x]  dimensions
  dz <- 5; dy <- 1; dx <- 1    # m/voxel, grid resolution, e.g. [dz] = m/voxel in z direction    
  ...
  # correction/clumping factor for PAD  
  PADfunction <- function(PAD){ PAD + 0 }
  # this function is called in Load_Static_Driver.R 
