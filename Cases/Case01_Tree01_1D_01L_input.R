#+
# NAME*:        Case01_Tree01_1D_01L_input.R
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #* name and range ####
  fnam.SD <- "Tree01_1D_01L.csv" # -, name of the static driver
...
#* Date description ####
  ...
  Tsme    <- 1                      # -, the given time is at the <s>tart 0, <m>id 0.5, or <e>nd 1 the interval
...
#* additional specifications for the wind field #
...
# General output switches ####
  silent <- 1     # Output control flag: 1: suppress print output within the time loop,  2: suppress print output completely
