...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #* name and range ####
  fnam.SD <- "Tree01_3D_20L.csv" # -, name of the static driver
  SD.dims = c( 20, 20,  20)      # -, [z,y,x]  dimensions
  dx <- 0.5; dy <- 1; dz <- 1    # m, grid resolution     
  ...
  x1.ref <-  0;  x2.ref <-  20  # east of the reference point
  y1.ref <-  0;  y2.ref <-  20  # north of the reference point
  z1.ref <-  0;  z2.ref <-  20     
...
#* Positioning of the measurements ####
   ...
   hWS <- c(500,1000)       # cm AGL, wind speed
